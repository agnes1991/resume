...
\cventry{2016/11\\至今}
{雷鸟}{TCL}{}{}
{1. 成立云端测试小组并担任组长，统筹公司所有云端项目测试，并协调部门内部各项测试工作事宜，包括项目管理，人员管理，人员优化等
2. 带领云端测试小组转型性能测试小组，并担任性能测试负责人，对公司全部项目的接口进行性能测试及接口自动化测试。期间完成性能测试整体预发布环境搭建，性能压测机环境搭建，并参与性能自动化平台开发
3. 独立负责多个项目的测试，包括雷鸟官网、智屏广告平台、电视launcher项目等，测试内容包括功能测试、性能测试、接口测试、web自动化测试、移动端app测试等多个方面。测试期间，完成测试各个阶段所需文档进行输出，并对项目风险进行管控。
}
