...
\section{专业技能}
\cvlistitem{功能测试、易用性测试、兼容性测试、自动化测试、安全测试}
\cvlistitem{掌握Python+Selenium自动化测试用例输出}
\cvlistitem{熟练编写测试用例、测试报告等文档}
